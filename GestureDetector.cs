...
namespace Microsoft.Samples.Kinect.ContinuousGestureBasics
{
    ...
    {
        /// <summary> Event framework for the mouse and keyboard </summary>
        ...
        //This simulates a left mouse click
        public static void dragMouseClick(int xpos, int ypos)
        {
            SetCursorPos(xpos, ypos);
            mouse_event(MOUSEEVENTF_RIGHTDOWN, xpos, ypos, 0, 0);
            SetCursorPos(xpos, ypos+20);
            ...
            using (var frame = this.vgbFrameReader.CalculateAndAcquireLatestFrame())
            {
                if (frame != null)
                {
                    ...
                    if (discreteResults != null)
                    {
                        ...
                        {
                            //Red view
                            LeftMouseClick(2980, 110);
                            //Yellow view
                            LeftMouseClick(2980, 688);
                            //Green view
                            LeftMouseClick(3920, 688);
                            steerLeft = true;
                            keepStraight = false;
                        }

                       /* if(!this.ClosedHandState)
                        {
                            MainWindow p = this.MainWindow;
                            SetCursorPos();
                        }*/
                        ...
                        {
                            //Red view
                            LeftMouseClick(3770, 110);
                            //Yellow view
                            LeftMouseClick(3770, 688);
                            //Green view
                            LeftMouseClick(4700, 688);
                            steerRight = true;
                            keepStraight = false;
                        }
                        ShowCursor(true);
